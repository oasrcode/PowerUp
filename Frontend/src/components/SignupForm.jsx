...
export function SignupForm() {
  return (
    <div className="flex flex-col  w-full h-full bg-slate-50 bg-inherit border-[9px] border-white text-white justify-evenly">
      <p className="text-center font-serif font-bold text-2xl pt-8">Sign up</p>
      <div className="pt-4">
        <form>
          <div className="w-full flex flex-col justify-center space-y-3 px-10 ">
            <label className="pl-1 text-gray-50 font-serif" for="user name">
              User name
            </label>
            <input
          ...
          <div className="w-full flex flex-col justify-center space-y-3 px-10 pt-5">
          ...
          <div className="w-full flex flex-col justify-center pt-5 space-y-3 px-10">
        ...
        <div className="w-full flex flex-col justify-center px-10">
          ...
          >
            <FcGoogle />
            <span className="pl-4 text-md">Google</span>
          </button>
        </div>
      </div>
    </div>
