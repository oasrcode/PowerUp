...
export function MessengeAlert({ message, prop }) {
  return (
    <div className="flex flex-row bg-green-300  z-10 border-2 border-green-700 p-3 absolute top-0 mt-20 lg:mt-0 2xl:mt-8 md:w-[60%] left-0 right-0 mx-auto rounded-lg h-14  w-full animate-pulse">
